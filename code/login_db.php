 ...
 * 使用到的接口函数：
 * user_login()	必须，判断登录用户的有效性
 * authcode()	可选，借用用户中心的函数加解密激活字串和 Cookie
 * user_synlogin()	可选，生成同步登录的代码
 */
...
if(empty($_POST['submit'])) {
	...
	list($uid, $username, $password, $email) = user_login($_POST['username'], $_POST['password']);
